...
getgenv().TweenSpeed = 300 -- 350 max or Get Tp Back
 getgenv().Setting = { -- Select Weapon, Self Explain
        ["Melee"] = {["Enable"] = true,["Delay"] = 3,
          ["Skills"] = {
            ["Z"] = {["Enable"] = true,["HoldTime"] = 1.25,["TimeToNextSkill"] = 0.5,},
            [ "X"] = {["Enable"] = true,["HoldTime"] = 1.25, ["TimeToNextSkill"] = 0.5,},
            ["C"] = {["Enable"] = true,["HoldTime"] = 1.25, ["TimeToNextSkill"] = 0.5,},
            },
        },
        ["Blox Fruit"] = {["Enable"] = true, ["Delay"] = 4,
            ["Skills"] = {
                ["Z"] = {["Enable"] = true, ["HoldTime"] = 0.5, ["TimeToNextSkill"] = 0.5,},
                ["X"] = { ["Enable"] = true, ["HoldTime"] = 0.5, ["TimeToNextSkill"] = 0.5,},
                ["C"] = { ["Enable"] = true, ["HoldTime"] = 0.5,["TimeToNextSkill"] = 0.5, },
                ["V"] = { ["Enable"] = true, ["HoldTime"] = 0.5,["TimeToNextSkill"] = 0.5,},
