...
--]]
	...
	getgenv()['Check_Setting'] = function(Name)
		if not _G.Dis and not isfolder('mbm Hub Srcipt Folder') then
			makefolder('mbm Hub Srcipt Folder')
		end
		if not _G.Dis and not isfile('mbm Hub Srcipt Folder/'..Name..'.json') then
			writefile('mbm Hub Srcipt Folder/'..Name..'.json',JsonEncode(_G.Setting_table))
		end
	end
	getgenv()['Get_Setting'] = function(Name)
		if not _G.Dis and isfolder('mbm Hub Srcipt Folder') and isfile('mbm Hub Srcipt Folder/'..Name..'.json') then
			_G.Setting_table = JsonDecode(readfile('mbm Hub Srcipt Folder/'..Name..'.json'))
	...
	function LoadSettings()
		if readfile and writefile and isfile and isfolder then
			if not isfolder("made by minh Hub Scripts") then
				makefolder("made by minh Scripts")
			end
			if not isfolder("made by minh Hub Scripts/Blox Fruits/") then
				makefolder("made by minh Hub Scripts/Blox Fruits/")
			end
			if not isfile("made by minh hub Scripts/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json") then
				writefile("made by minh Hub Scripts/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json", game:GetService("HttpService"):JSONEncode(_G.Settings))
			else
				local Decode = game:GetService("HttpService"):JSONDecode(readfile("made by minh Hub Scripts/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json"))
	...
	function SaveSettings()
		if readfile and writefile and isfile and isfolder then
			if not isfile("made by minh Hub Scripts/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json") then
				...
				writefile("made by minh Hub Scripts/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json", game:GetService("HttpService"):JSONEncode(Array))
			end
		else
			return warn("Status : Undetected Executor")
		end
...
SOMEXHUBMODILE.Name = "SOMEXHUBMODILE"
        ...
        MODILEMAGE.Image = "http://www.roblox.com/asset/?id=15582682098"
...
function Update:Window(text,logo,keybind)
	...
	local yoo = string.gsub(tostring(keybind),"Enum.KeyCode.RightControl","RightControl")
...
local LogoHub = Instance.new("ImageLabel")
	...
	LogoHub.Image = "http://www.roblox.com/asset/?id="..tostring(15582682098)
...
local LogoToggle = Instance.new("ImageLabel")
	...
	LogoToggle.Image = "http://www.roblox.com/asset/?id="..tostring(15582682098)
...
local Library = Update:Window("mbm","2.0",Enum.KeyCode.RightControl);

Main = Library:Tab("Genneral",15582682098)
Sta = Library:Tab("Stats",15582682098)
Miscf = Library:Tab("MiscFarm",15582682098)
Sho = Library:Tab("Fruit",15582682098)
Shop = Library:Tab("Shop",15582682098)
Raid = Library:Tab("Raid",15582682098)
TPKub = Library:Tab("Teleport",15582682098)
Py = Library:Tab("Players",15582682098)
...
spawn(function()
        while wait() do
            if AutoFindFullmoon then
                pcall(function()
                    if not game:GetService("Lighting").Sky.MoonTextureId=="http://www.roblox.com/asset/?id=15582682098" then
                        wait(3)
                        HopServer()
                    end
                end)
...
Main:Label("mbm & m1m hub made by m.1.M in discord")
