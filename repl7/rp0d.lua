...
--tabs
local creditTabs = {
    Main = Window:AddTab({ Title = "Credit", Icon = "clipboard" }),
}
local scriptTabs = {
    Main = Window:AddTab({ Title = "gaf", Icon = "clipboard" }),
    
}
local mimTabs = {
    Main = Window:AddTab({ Title = "mine", Icon = "clipboard"})
}
local plTabs = {
    Main = Window:AddTab({ Title = "Player", Icon = "clipboard"})
}
local miscTabs = {
    Main = Window:AddTab({ Title = "Misc", Icon = "clipboard"})
}
--mentions
